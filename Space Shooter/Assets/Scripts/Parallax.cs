...
using UnityEngine;
public class Parallax : MonoBehaviour{ //Nome do Script
...
void FixedUpdate() { //Todos os fixedUpdate ocorrem depois dos Updates
...
if (transform.position.y < fimTela.transform.position.y) { //Verifica se as nuvens
